...
namespace NormalUncertainty.Experiments.Article
{
    public class Experiment12
    {
        ...
        public void Run(string baseOutputDir, int targetScenarioCount = 10_000, int batchSize = 200, float stopThreshold = 0.05f)
        {
            Console.WriteLine("--- Experiment 12: Sampling Strategy Benchmark ---");
            ...
            Parallel.ForEach(testScenarios, (scenario) =>
            {
                ...
                corners.Sample(512); // Actually evaluates up to 512
